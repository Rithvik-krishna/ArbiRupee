...
async function deployWorkingArbINR() {
  console.log('🚀 Deploying Working ArbINR Contract...');
  ...
  try {
    ...
    // Use a simple approach - deploy using ethers built-in ERC20
...
module.exports = { deployWorkingArbINR };
